export function SiteHeader() {
  return <header className="site-header"><a className="brand" href="/"><span className="brand-mark">★</span><span>Paycheck <b>Atlas</b></span></a><nav aria-label="Main navigation"><a href="/">Paycheck Calculator</a><a href="/state-paycheck-calculators">States</a><a href="/salary-calculator">Salary Calculator</a><a href="/hourly-paycheck-calculator">Hourly Pay</a><a href="/how-much-tax-is-taken-from-my-paycheck">Paycheck Taxes</a><a href="/methodology">How It Works</a></nav><span className="year-pill">2026 methods</span></header>;
}
