...
const supportedStates: {code:SupportedState;name:string}[] = [
  {code:"AL",name:"Alabama"},{code:"AZ",name:"Arizona"},{code:"AR",name:"Arkansas"},{code:"CA",name:"California"},{code:"CO",name:"Colorado"},{code:"CT",name:"Connecticut"},{code:"FL",name:"Florida"},{code:"GA",name:"Georgia"},{code:"HI",name:"Hawaii"},{code:"ID",name:"Idaho"},{code:"IL",name:"Illinois"},{code:"IN",name:"Indiana"},{code:"IA",name:"Iowa"},{code:"KS",name:"Kansas"},{code:"KY",name:"Kentucky"},{code:"LA",name:"Louisiana"},{code:"MD",name:"Maryland"},{code:"MA",name:"Massachusetts"},{code:"MI",name:"Michigan"},{code:"MN",name:"Minnesota"},{code:"MO",name:"Missouri"},{code:"NC",name:"North Carolina"},{code:"NE",name:"Nebraska"},{code:"NV",name:"Nevada"},{code:"NJ",name:"New Jersey"},{code:"NY",name:"New York"},{code:"NYC",name:"New York City resident"},{code:"OH",name:"Ohio"},{code:"OK",name:"Oklahoma"},{code:"OR",name:"Oregon"},{code:"PA",name:"Pennsylvania"},{code:"SC",name:"South Carolina"},{code:"TN",name:"Tennessee"},{code:"TX",name:"Texas"},{code:"UT",name:"Utah"},{code:"VA",name:"Virginia"},{code:"WA",name:"Washington"},{code:"WI",name:"Wisconsin"},
];

const allowanceStates = new Set<SupportedState>(["AL","AR","CA","GA","HI","ID","IL","IN","KS","MA","MD","MI","MN","NC","NE","NJ","NY","NYC","OH","OK","OR","SC","VA","WI"]);
...
export default function PaycheckCalculator({defaultState="TX",defaultFrequency="biweekly",hourly=false,navigateOnStateChange=false}:{defaultState?:SupportedState;defaultFrequency?:PayFrequency;hourly?:boolean;navigateOnStateChange?:boolean}) {
  ...
  return <div className="calculator national-calculator" id="calculator">
    <section className="inputs">
      ...
      {status==="married"&&(["GA","IA","MO"] as SupportedState[]).includes(state)&&<CheckboxField label="Spouse also has wage income" checked={spouseWorks} setChecked={setSpouseWorks}/>} 
