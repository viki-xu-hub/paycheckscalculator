...
export const metadata: Metadata = {
  ...
  description: "See your take-home pay at every salary level from $25,000 to $300,000. Pick your salary for a full 52-state after-tax breakdown.",
    ...
    <main>
      ...
      <div className="directory">
        ...
        <p style={{ color: "#647789", maxWidth: 620, margin: "12px auto 0", lineHeight: 1.6, fontSize: 15 }}>
          Select your annual salary below for a full breakdown of take-home pay across all 52 states.
        ...
        <div style={{ marginTop: 60, padding: "32px 28px", background: "white", border: "1px solid #d9e2e7", borderRadius: 12, maxWidth: 700, marginLeft: "auto", marginRight: "auto", textAlign: "left" }}>
          ...
          <h2 style={{ font: "700 24px/1.2 var(--font-geist-sans),Arial,sans-serif", margin: "8px 0 12px" }}>What each salary page shows</h2>
          <p style={{ color: "#5f7485", fontSize: 14, lineHeight: 1.75 }}>
            Every salary page runs a full payroll calculation for all 52 supported states using
