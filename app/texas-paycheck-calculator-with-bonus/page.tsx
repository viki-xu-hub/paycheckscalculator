...
const OG_IMAGE = [{ url: "/og.png", width: 1200, height: 630, alt: "Texas Paycheck Calculator With Bonus 2026" }];
const LAST_MODIFIED = "2026-08-29";

const fmt = new Intl.NumberFormat("en-US", { style: "currency", currency: "USD", maximumFractionDigits: 0 });

export const metadata: Metadata = {
  title: "Texas Paycheck Calculator With Bonus — 2026 Take-Home Pay",
  description:
    "See what a bonus adds to your Texas paycheck in 2026. Compare the 22% flat supplemental rate with the aggregate method, including Social Security and Medicare. No Texas state income tax on wages.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Texas Paycheck Calculator With Bonus — 2026 Take-Home Pay",
    description:
      "Estimate bonus take-home pay in Texas under both federal supplemental withholding methods, with FICA included and no state income tax.",
    url: CANONICAL,
    type: "website",
...
const faqs = [
  {
    q: "How much of my bonus will I take home in Texas?",
  ...
  {
    q: "Why was so much withheld from my bonus?",
...
export default function TexasPaycheckCalculatorWithBonus() {
  const softwareSchema = {
    ...
    name: "Texas Paycheck Calculator With Bonus",
    url: CANONICAL,
    applicationCategory: "FinanceApplication",
    operatingSystem: "Any",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description:
      "Free Texas bonus paycheck calculator for 2026. Compare the 22% flat supplemental withholding method with the aggregate method and see bonus take-home pay after federal tax and FICA.",
  };
  ...
  const webPageSchema = {
    ...
    about: "Supplemental wage withholding on bonuses for Texas employees",
    description:
      "Estimate the take-home value of a bonus in Texas under both federal supplemental withholding methods.",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "With Bonus", item: CANONICAL },
    ],
  };
  ...
  return (
    <main>
      ...
      <section className="hero">
        <div className="eyebrow">TEXAS · SUPPLEMENTAL WAGE WITHHOLDING</div>
        <h1>Texas Paycheck Calculator With Bonus: What You Actually Take Home</h1>
      ...
      <section className="seo-section text-left">
        <p className="kicker">HOW BONUSES ARE WITHHELD</p>
        <h2>How a Bonus Is Taxed on a Texas Paycheck</h2>
        ...
        <h3>The percentage method — a flat 22%</h3>
        <p>
          ...
          Medicare (1.45%, plus 0.9% on wages above $200,000) still apply. Above $1 million of supplemental
        ...
        <h3>What Texas changes</h3>
        <p>
          Texas has no individual income tax on wages, so there is no state supplemental rate to apply. A Texas
          bonus keeps more than the same bonus paid in a state that withholds state income tax on supplemental
          wages.
        </p>
      </section>
      ...
      <section className="seo-section text-left">
        ...
        <h2>Texas Bonus Take-Home Pay Examples</h2>
        <p className="seo-section-intro">
      ...
      <section className="seo-section text-left">
        ...
        <h2>How to Use This Texas Bonus Calculator</h2>
      ...
      <section className="seo-section text-left">
        ...
        <h2>Limits of a Bonus Withholding Estimate</h2>
        ...
        <p style={{ marginTop: 16, color: "#667a8a", lineHeight: 1.7, fontSize: 14 }}>
          ...
          the calculator accounts for wages already taxed.
        </p>
      </section>
      ...
      <section className="seo-section">
        ...
        <p>
          This page covers bonuses. Start from the{" "}
